...
const Personagem4 = ({ route, navigation }) => {
  ...
  const handleFinalizarCadastro = async (personagem) => {
    ...
    switch (personagem) {
      case 'personagem4':
        personagemImagem = require('../img/circuloBob.png');
        break;
      default:
      ...
      <TouchableOpacity onPress={Casa} style={{ zIndex: 1000}}>
        ...
        <View style={styles.fundo}>
          <Text style={styles.fundo2}>
            Bob Banana é tímido e doce, embora se assuste fácil.
          </Text>
        </View>
        ...
        <View style={styles.characterListContainer}>
          ...
          />
          <TouchableOpacity style={styles.chooseButton} onPress={() => handleFinalizarCadastro('personagem4')}>
            <Image
