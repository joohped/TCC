...
const Modal3 = ({ visible, onClose, dica }) => (
  <Modal
    animationType="slide"
    transparent={true}
    visible={visible}
      ...
      <View style={styles.modalView}>
        ...
        <View style={styles.contentView}>
          <ScrollView>
            ...
            <Text style={{fontSize: 19, fontFamily: 'QuickDelight', textAlign: 'left', marginTop: 15}}>{dica.subtitle1}</Text>
            <Text style={{fontSize: 19, fontFamily: 'QuickDelight', textAlign: 'left', marginTop: 10}}>{dica.subtitle2}</Text>
            <Text style={{fontSize: 19, fontFamily: 'QuickDelight', textAlign: 'left', marginTop: 10}}>{dica.subtitle3}</Text>
            <Text style={{fontSize: 19, fontFamily: 'QuickDelight', textAlign: 'left', marginTop: 10}}>{dica.subtitle4}</Text>

            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.text4}</Text>
            ...
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text7}</Text>
          </ScrollView>
          <TouchableOpacity
