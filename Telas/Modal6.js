...
const Modal6 = ({ visible, onClose, dica }) => (
  <Modal
    animationType="slide"
    transparent={true}
    visible={visible}
      ...
      <View style={styles.modalView}>
        ...
        <View style={styles.contentView}>
          <ScrollView>
            ...
            <Text style={{fontSize: 20, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.subtitle2}</Text>
            <Text style={{fontSize: 18, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text3}</Text>

            <Text style={{fontSize: 20, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.subtitle3}</Text>
            <Text style={{fontSize: 18, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text4}</Text>

            <Text style={{fontSize: 20, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.subtitle4}</Text>
            <Text style={{fontSize: 18, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text5}</Text>
          
            <Text style={{fontSize: 20, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.subtitle5}</Text>
