...
const Modal4 = ({ visible, onClose, dica }) => (
  <Modal
    animationType="slide"
    transparent={true}
    visible={visible}
      ...
      <View style={styles.modalView}>
        ...
        <View style={styles.contentView}>
          <ScrollView>
            ...
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 20}}>{dica.text2}</Text>
            ...
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.text5}</Text>
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text6}</Text>
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.text7}</Text>
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text8}</Text>
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 15}}>{dica.text9}</Text>
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text10}</Text>
            <Text style={{fontSize: 17, fontFamily: 'QuickDelight', textAlign: 'justify', marginTop: 10}}>{dica.text11}</Text>
          </ScrollView>
          <TouchableOpacity
