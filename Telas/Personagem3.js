...
const Personagem3 = ({ route, navigation }) => {
  const {
    email,
    senha,
    nome_r,
  ...
  const handleFinalizarCadastro = async (personagem) => {
    ...
    switch (personagem) {
      case 'personagem3':
        personagemImagem = require('../img/circuloBella.png');
        break;
      default:
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity onPress={Casa} style={{ zIndex: 1000}}>
        ...
        <Image source={require('../img/bellaBrocolis.png')} style={styles.imagemTitulo} />
        <Image source={require('../img/personagem3.png')} style={styles.imagemPersonagem} />

        <View style={styles.botaoCurvado} />
        <View style={styles.fundo}>
          <Text style={styles.fundo2}>
            Bella Brocolis é apaixonada por dança e participa de um grupo de líderes de torcida.
          </Text>
        </View>
        ...
        <View style={styles.containerListaPersonagem}>
          ...
          />
          <TouchableOpacity style={styles.botaoEscolhido} onPress={() => handleFinalizarCadastro('personagem3')}>
            <Image
